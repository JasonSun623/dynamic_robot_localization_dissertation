\subsection{Kinect with translation motions at 20 cm/s}
...
\begin{figure}[H]
	\centering
	\animategraphics[width=0.62\textwidth,loop,autoplay,controls]{1}{appendices/tests-6dof/kinect/\currfilebase/images-drl/image}{1}{60}
	\caption{Point clouds projected on top of the map using the localization system poses}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.62\textwidth]{appendices/tests-6dof/kinect/\currfilebase/graphs/robot-movement-path}
