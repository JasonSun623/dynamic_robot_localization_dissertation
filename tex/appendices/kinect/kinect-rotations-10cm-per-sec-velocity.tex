...
\begin{figure}[H]
	\centering
	\animategraphics[width=0.64\textwidth,loop,autoplay,controls]{1}{appendices/tests-6dof/kinect/\currfilebase/images-drl/image}{1}{60}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.63\textwidth]{appendices/tests-6dof/kinect/\currfilebase/graphs/robot-movement-path}
