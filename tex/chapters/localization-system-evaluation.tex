...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.28\textwidth]{localization-system-evaluation/jarvis}
...
\begin{figure}
	...
	\begin{minipage}[h]{0.497\textwidth}
		\centering
		\includegraphics[width=0.67\textwidth]{localization-system-evaluation/guardian}
		\caption{Guardian testing platform}
		\label{fig:localization-system-evaluation_guardian}
	\end{minipage}\hfill
	\begin{minipage}[h]{0.497\textwidth}
		\centering
		\includegraphics[width=0.67\textwidth]{localization-system-evaluation/guardian-gazebo}
...
\begin{figure}
	...
	\begin{subfigure}[h]{.497\textwidth}
		\centering
		\includegraphics[width=\textwidth]{localization-system-evaluation/jarvis-environment-back-left}
	\end{subfigure}
	\begin{subfigure}[h]{.497\textwidth}
		\centering
		\includegraphics[width=\textwidth]{localization-system-evaluation/jarvis-environment-back-right}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[h]{.497\textwidth}
		\centering
		\includegraphics[width=\textwidth]{localization-system-evaluation/guardian-environment-corner}
	\end{subfigure}
	\begin{subfigure}[h]{.497\textwidth}
		\centering
		\includegraphics[width=\textwidth]{localization-system-evaluation/guardian-environment-inside}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\includemedia[
		...
		3Dviews=figures/localization-system-evaluation/guardian-environment.vws,
		width=\linewidth,
		height=0.5\linewidth,
		activate=pageopen,3Dtoolbar,3Dmenu
	]{}{figures/localization-system-evaluation/guardian-environment.u3d}
	\caption{Interactive \glsentrytext{cad} of Guardian tests environment (.u3d file)}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{localization-system-evaluation/jarvis-circular-path-5cm-per-sec-velocity-1-scan}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{localization-system-evaluation/jarvis-complex-path-with-outliers-5cm-per-sec-velocity-2-scans}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{localization-system-evaluation/ship-interior-cluttered-dinamic-30cm-per-sec}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{localization-system-evaluation/ship-interior-initial-pose-estimation-sift-fpfh-ransac-gicp}
...
\begin{sidewaystable}
	...
	\begin{tabu} to \textwidth { X[m,c] X[m,c] X[m,c] X[1.5,m,c] X[m,c] X[m,c] X[m,c] X[m,c] X[m,c] X[m,c] X[m,c] X[m,c] X[m,c] }
		\hline
		\multicolumn{5}{c}{Test conditions} & \multicolumn{2}{c}{Translation error (millimeters)} & \multicolumn{2}{c}{Rotation error (degrees)} & \multicolumn{2}{c}{Outliers percentage [0..100]} & \multicolumn{2}{c}{Global computation time (milliseconds)} \\ \hline
