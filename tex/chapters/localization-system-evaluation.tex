...
\input{tex/chapters/localization-system-evaluation/jarvis-robot-circular-path-5cm-per-sec-velocity-1-scan.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/jarvis-robot-complex-path-with-outliers-5cm-per-sec-velocity-2-scans.tex} \clearpage


\subsection{Jarvis simulator tests}

\input{tex/chapters/localization-system-evaluation/jarvis-simulator-circular-path-5cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/jarvis-simulator-circular-path-50cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/jarvis-simulator-circular-path-100-per-sec-velocity-1-scan.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/jarvis-simulator-complex-path-with-outliers-5cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/jarvis-simulator-complex-path-with-outliers-50-30-50-20cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/jarvis-simulator-complex-path-with-outliers-200-30-200-30cm-per-sec-velocity-2-scans.tex} \clearpage


\subsection{Guardian simulator tests}

\input{tex/chapters/localization-system-evaluation/guardian-simulator-static-front-and-back-laser-5cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/guardian-simulator-static-front-and-back-laser-30cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/guardian-simulator-cluttered-front-and-back-laser-5cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/guardian-simulator-cluttered-front-and-back-laser-30cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/guardian-simulator-cluttered-dynamic-front-and-back-laser-5cm-per-sec-velocity-2-scans.tex} \clearpage
\input{tex/chapters/localization-system-evaluation/guardian-simulator-cluttered-dynamic-front-and-back-laser-30cm-per-sec-velocity-2-scans.tex} \clearpage
