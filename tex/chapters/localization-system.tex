...
\begin{figure}[H]
	...
	\caption{Laser assembly (red points) with tilting platform}
...
\begin{figure}[H]
	...
	\begin{minipage}[h]{0.495\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{localization-system/voxel-grid-downsampling-1}
	\end{minipage}\hfill
	\begin{minipage}[h]{.495\textwidth}
		\centering
	\includegraphics[width=0.98\textwidth]{localization-system/voxel-grid-downsampling-2}
	\end{minipage}
...
\subsection{Initial alignment with keypoints descriptor matching}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{localization-system/outlier-detection}
