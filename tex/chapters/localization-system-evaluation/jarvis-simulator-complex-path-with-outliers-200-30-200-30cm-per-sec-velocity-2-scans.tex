...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.72\textwidth]{localization-system-evaluation/tests-3dof/jarvis-simulator-complex-path-with-outliers-200-30-200-30cm-per-sec-velocity-2-scans/robot-movement-path-with-odometry}
