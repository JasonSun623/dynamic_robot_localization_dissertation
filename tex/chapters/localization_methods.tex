...
\begin{figure}[h]
	...
	\caption{Different types of optical encoders used to measure distances\protect\footnotemark}
...
\subsection{\glsentrydesc{tof} methods}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.55\textwidth]{localization_methods/lidar_scan}
	\caption{\glsentrytext{lidar} scan\protect\footnotemark}
...
\begin{figure}[ht]
	...
	\begin{minipage}[h]{.495\textwidth}
		...
		\caption{\glsentrytext{radar} scan of two ships\protect\footnotemark}
		\label{fig:localization_methods_radar-scan}
	\end{minipage}\hfill
	\footnotetext{\url{http://www.sintef.no/Projectweb/STSOps/News/Operational-Aspects-on-Decision-making-in-STS-Lightering/}}
	\begin{minipage}[h]{.495\textwidth}
		\centering
		\includegraphics*[width=\textwidth]{localization_methods/sonar_scan}
		\caption{\glsentrytext{sonar} scan of two ships\protect\footnotemark}
		\label{fig:localization_methods_sonar-scan}
	\end{minipage}
	\footnotetext{\url{http://stellwagen.noaa.gov/maritime/palmercrary.html}}
\end{figure}
\end{savenotes}
}
...
\paragraph{\glsentryfirst{gnss}}

Global localization systems such as the \gls{gps} or \gls{glonass}, allow 3D positioning in the planet Earth  using a trilateration method \cite{Knedlik2007}.
